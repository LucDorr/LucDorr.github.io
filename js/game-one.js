...
standimage.src = "picgameone/mecool.png";

var cactus = new Image();
cactus.src = "cactus.png";

var cactus2image = new Image();
cactus2image.src = "picgameone/thaboys.png";
...
var player = {
    ...
    update: function () {
        if (this.y < 470) {
            gamearea.context.drawImage(standimage, this.x, this.y - 70, 90, 80);
        }
        else {
...
function obstacle() {
    ...
    this.draw = function () {
        if (this.enemytype == "cactus") {
            ...
            gamearea.context.drawImage(cactus2image, this.x, this.y - 43, 150, this.height + 50);
        }
        else {
